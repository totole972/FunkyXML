...
public class UserInterface {
	...
	private void setRadioButtons() {
	    ...
	    JPanel p = new JPanel();
        p.setBorder(BorderFactory.createTitledBorder("Choose a converting type"));
        ...
        xmltojsonRadioButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                communicationField.setText("You've just chosen the " + converter + ".");
            }
	...
	private void setLabel() {
	    // Description label
        JLabel fileLabel = new JLabel("<html><u>Choose a file to convert:</u></html>");
	...
	private void setTextFields() {
        ...
        // Communication field that indicates the messages (errors, convertions done)
        ...
        convertButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                switch(converter) {
                    case XML_TO_JSON:
                        args[0] = "xml";
                        args[2] = args[1].substring(0,args[1].lastIndexOf('.')) + "converted.json";
                        break;
                    case JSON_TO_XML:
                        args[0] = "json";
                ...
                if (!console.App.checkParam(args)) {
                    ...
                    if (!isSaved) {
                        communicationField.setText("An error occurs when converting/saving the file.");
                    }
                    else {
                        communicationField.setText("The file has been converted and saved!");
                    }
                }
            }
